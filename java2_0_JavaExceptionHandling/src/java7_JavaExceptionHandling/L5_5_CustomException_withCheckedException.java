...
public class L5_5_CustomException_withCheckedException {
	...
	private static void method2() throws Exception {
		...
		/* 	Method: add4()is created to handle Checked exception
		 ...
		 */
		System.out.println("Method add4()=> Sum of Amounts: Matching Currencies..");
		amt1.add4(amt2);
		System.out.println(amt1);
		
		System.out.println("Method add4()=> Sum of Amounts: Different currencies with CheckedException Handling..");
		amt1.add4(amt3);
		System.out.println(amt1);
