...
public class L3_Ex1_GenericsWildcardsRunner {
	 ...
	 * It can accept different numeric data types like - integer, Double, Long &
	 * will return sum as a double data type.
	 * 
	 * Here 'extends' is used as Upper Bounded WildCard. Helps in implementing
	 * common logic for all the list which extends number
	 */
	...
	/*
	 * Here, 'super' is used as Lower Bounded WildCard It helps in adding elements
	 * which are sub types of Number to the list
	 */
