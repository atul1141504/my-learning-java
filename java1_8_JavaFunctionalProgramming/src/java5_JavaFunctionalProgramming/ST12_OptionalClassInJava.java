...
public class ST12_OptionalClassInJava {
	/*
	 * 	Optional Class returns an Optional in case no valid data is getting returned 
	 *  or to null return
	...
	public static void main(String[] args) {
		...
		//get odd Minimum & even Maximum number present in the list
		getMinOddNumberInList(intList);
		getMinEvenNumberInList(intList);
		
		List<Integer> newIntOddList = List.of(13,19,15,17,7);
		System.out.println("Odd Integer List==>"+newIntOddList.toString());
	...
	public static void getMinOddNumberInList(List<Integer> List) {
		System.out.println("\t  Min Odd Number present in the list....==>"
				+ List.stream().filter(e->e%2==1)
		...
		System.out.println("\t  Min Odd Number present in the list....==>" + min);
		
		System.out.println("\t  Is data present.......................==>"
								+ List.stream().filter(e->e%2==1)
												.min((n1, n2) -> Integer.compare(n1, n2))
												.isPresent());
	...
	static void getMinEvenNumberInList(List<Integer> List) {
		...
		System.out.println("\t  Min Even Number present in the list....==>"
		...
		Integer min = List.stream()
				...
				.min( 						// Terminal Operation
					(n1, n2) -> Integer.compare(n1, n2))
				.orElse(-1);				//orElse() is performed on the Optional function

		System.out.println("\t  Min Even Number present in the list....==>" + min);
